...
export const STEPS = [
  ...
  export const TESTIMONIALS = [
    {
      quote:
        "With SplitGenius AI, I finally stopped getting confused about who paid for what!",
      name: "david",
    ...
    {
      quote:
        "SplitGenius AI's calculations are so accurate, they're even better than my scheme to double money in 25 days!",
      name: "catherine",
      image: "/testimonials/catherine.jpeg",
      role: "Stock Market Expert",
    },
    {
      quote:
        "If that I have SplitGenius AI, Michael won't get away with selling my shoes and coat! I'll add to his debt!",
      name: "Kevin",
      image: "/testimonials/kevin.jpeg",
      role: "Job Searcher",
    },
  ];
